...
import {
  View, Text, StyleSheet, Pressable, FlatList, ScrollView, Modal, Dimensions,
} from 'react-native';
import {
  Settings, ArrowLeft, Grid3X3, Users, Bell, Plus,
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.tabContent}>
        {activeTab === 'listings' && (
          <FlatList
            data={[...currentUser.listings, null] as (ListingItem | null)[]}
            numColumns={3}
