-- ============================================================
-- Migration 20240020: Repair reservation function drift
-- Reasserts the intended post-20240019 reservation helpers so
-- upgraded and freshly rebuilt databases converge on the same
-- function definitions without editing historical migrations.
-- ============================================================
